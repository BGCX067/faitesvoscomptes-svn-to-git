...
public class CleanDBAdapter {
	...
	public class DatabaseHelper extends SQLiteOpenHelper{
		...
		public DatabaseHelper(Context context) {
			super(context, "CLEANoutGoing", null, 1);
			this.context = context;
		}


		public void onCreate(SQLiteDatabase db) {
			db.execSQL("create table CLEANoutGoing (_id integer primary key autoincrement, "
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			db.execSQL("DROP TABLE IF EXISTS CLEANoutGoing");
			onCreate(db);
		}
		
	}
	
	public CleanDBAdapter open(){
	...
	public void Truncate(){
		db.execSQL("DELETE FROM CLEANoutGoing");
	}
	...
	public long insertOutgoing(String montant, String raison, String date){
		...
		return db.insert("CLEANoutGoing", null, values);
	}
	
	
	public boolean deleteOutgoing(long id){
		return db.delete("CLEANoutGoing", "_id="+id, null)>0;
	}
	
	public Cursor getOutgoing(){

		return db.query("CLEANoutGoing", new String[]{
				"_id",
				"montant",
				"raison",
